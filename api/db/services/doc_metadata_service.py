...
class DocMetadataService:
    ...
    def update_document_metadata(cls, doc_id: str, meta_fields: dict, *, refresh_now: bool = True) -> bool:
        ...
        ``docnm_kwd`` on them."""
        ok = cls._update_document_metadata_store(doc_id, meta_fields, refresh_now=refresh_now)
        if ok:
    ...
    @classmethod
    def _update_document_metadata_store(cls, doc_id: str, meta_fields: dict, *, refresh_now: bool = True) -> bool:
        """
